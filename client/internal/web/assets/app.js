...
const I18N = {
  ru: {
    ...
    "router.tg_topic": "топик", "router.tg_topic_ph": "id, опционально",
    ...
    "svc.launch_badge": "После открытия порта клиент сам запускает {kind}",
  ...
  en: {
    ...
    "router.tg_topic": "topic", "router.tg_topic_ph": "id, optional",
    ...
    "svc.launch_badge": "After the port opens the client launches {kind} itself",
    ...
    wrap.append(h("div", { class: "card pad row", style: s.enabled ? "" : "opacity:.62" },
      ...
      h("span", { class: "grow" },
        h("div", { class: "row" }, h("span", { class: "mono", style: "font-weight:600" }, s.name),
          ...
          s.launch && h("span", { class: "badge grey", "data-tip": t("svc.launch_badge", { kind: s.launch.toUpperCase() }) },
            icon("launch", "ic-sm"), s.launch.toUpperCase())),
...
function openRouterModal(name) {
  ...
  const paneNotify = h("div", { class: "modal-body hidden" },
    ...
    chan(g.nt, "Telegram",
      // Token first and full width — it is the long value; the two short ids
      // sit below it side by side.
      field("bot token", g.tg_token),
      h("div", { class: "grid2" }, field("chat id", g.tg_chat), field(t("router.tg_topic"), g.tg_thread)),
      h("div", { class: "note" }, t("router.tg_topic_note"))),
    chan(g.ne, "Email",
